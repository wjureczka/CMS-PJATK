...
INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(2, '2021-01-01', '2021-12-31', 'Karta graficzna Gigabyte GeForce RTX 3070 Gaming', 3200, 3, 4,
 'Dwa wentylatory w połączeniu z wydajnym chłodzeniem + osiągi których oczekujesz! Najlepsza w swojej cenie!'
);

INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(3, '2021-01-01', '2021-12-31', 'Karta graficzna XFX Radeon RX 580 GTS', 2600, 3, 6,
 'Dwa wentylatory w połączeniu z wydajnym chłodzeniem + osiągi których oczekujesz! Najlepsza w swojej cenie!'
);

INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(4, '2021-01-01', '2021-12-31', 'Pamięć HyperX Fury RGB, DDR4', 4300, 4, 8,
...
INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(5, '2021-01-01', '2021-12-31', 'Procesor Intel Core i5-10400F', 1600, 2, 1,
...
INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(6, '2021-01-01', '2021-12-31', 'Procesor AMD Ryzen %950x', 4600, 2, 2,
...
INSERT INTO product(id, date_from, date_to, description, price, category_id, producer_id, long_description)
VALUES(7, '2021-01-01', '2021-12-31', 'Pamięć ADATA Gammix D10,', 4600, 4, 9,
 'Pamięć dla zaawansowanych graczy! Możliwości podkręcania wraz ze świetnym chłodzeniem to osiągi których wymagasz. Najwyższa jakość w świetnej cenie.'
);
